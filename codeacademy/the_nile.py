'''
1. At The Nile our biggest concern is our consumers, and our biggest cost is delivering their goods to them. 
...
2.Both from_coords and to_coords are tuples, containing first the latitude and then the longitude. 
...
7. What about our shoppers who hastily purchase goods without indicating their shipping type? Let’s give our function a default argument for shipping_type. 
...
9. Write a function called calculate_driver_cost() with distance as the first parmameter, 
...
15. In an elif statment, check if price_for_driver is less than cheapest_driver_price. 
...
17. Let’s define a function called calculate_money_made(). This function will be passed a number of Trip IDs with corresponding trip information as arguments, 
...
22. Outside your for loop, return the total! Remember you can test your function by calling test_function(calculate_money_made) afterwards!
'''

from nile import get_distance, format_price, SHIPPING_PRICES
from test import test_function #(import files not included)
